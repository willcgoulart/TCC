  ...
  <section class="home-section">
    <div class="container">
      ...
      <div class="row mt-2">
        ...
        @foreach ( $todasTarefasPe as $key => $dados )
          @php 
        ...
        @foreach ( $todasTarefasFa as $key => $dados )
          @php 
            $arrayIdTarefas = explode("|",$dados->id_tarefa);
            $arrayDescTarefas = explode("|",$dados->desc_tarefa);
            $arrayDataEntrega = explode("|",$dados->data_entrega);
        ...
        @foreach ( $todasTarefasPa as $key => $dados )
          @php 
            $arrayIdTarefas = explode("|",$dados->id_tarefa);
            $arrayDescTarefas = explode("|",$dados->desc_tarefa);
            $arrayDataEntrega = explode("|",$dados->data_entrega);
        ...
        @foreach ( $todasTarefasCo as $key => $dados )
          @php 
            $arrayIdTarefas = explode("|",$dados->id_tarefa);
            $arrayDescTarefas = explode("|",$dados->desc_tarefa);
            $arrayDataEntrega = explode("|",$dados->data_entrega);
